...
for pair_best in find_all:
    ...
    if not os.path.isdir("mosaic_RNN"):
        os.makedirs("mosaic_RNN/")

    filename = "mosaic_RNN/Vehicle_" + vehicle + "_events_" + ride + "_" + model_name + "_" + dist_name + "_" + dist_name.replace("long", "lat") + "_test_mosaic.png"
    ...
    for model_name in predicted_long:
        for dist_name in predicted_long[model_name]:
            ...
            for v in set(int_veh):
                ...
                filename_veh = "mosaic_RNN/Vehicle_" + str(v) + "_" + model_name + "_" + dist_name + "_" + dist_name.replace("long", "lat") + "_test_mosaic.png"
                draw_mosaic(all_actual_vehicle, all_predicted, filename_veh)

            filename = "mosaic_RNN/all_" + model_name + "_" + dist_name + "_" + dist_name.replace("long", "lat") + "_test_mosaic.png"
