...
if train_a_model:
    for filename in os.listdir("actual_train"):
        for ws_use in ws_range:
            ...
            if not os.path.isdir("train_attention" + str(ws_use - min(ws_range) + 1 + len(ws_range) * 3) + "/" + varname + "/models/" + model_name):
                os.makedirs("train_attention" + str(ws_use - min(ws_range) + 1 + len(ws_range) * 3) + "/" + varname + "/models/" + model_name)

            if not os.path.isdir("train_attention" + str(ws_use - min(ws_range) + 1 + len(ws_range) * 3) + "/" + varname + "/predictions/test/" + model_name):
                os.makedirs("train_attention" + str(ws_use - min(ws_range) + 1 + len(ws_range) * 3) + "/" + varname + "/predictions/test/" + model_name)
        
            save_object("train_attention" + str(ws_use - min(ws_range) + 1 + len(ws_range) * 3) + "/" + varname + "/models/" + model_name + "/" + varname + "_" + model_name + "_ws_" + str(ws_use) + "_train_losses", train_losses)

            save_object("train_attention" + str(ws_use - min(ws_range) + 1 + len(ws_range) * 3) + "/" + varname + "/models/" + model_name + "/" + varname + "_" + model_name + "_ws_" + str(ws_use) + "_val_losses", val_losses)
            
            model.seq2seq.eval()
            torch.save(model.seq2seq.state_dict(), "train_attention" + str(ws_use - min(ws_range) + 1 + len(ws_range) * 3) + "/" + varname + "/models/" + model_name + "/" + varname + "_" + model_name + "_ws_" + str(ws_use) + ".pth")
            ...
            with torch.no_grad():
                ...
                print_predictions(y_test_all, predict_test_all, "train_attention" + str(ws_use - min(ws_range) + 1 + len(ws_range) * 3) + "/" + varname + "/predictions/test/" + model_name + "/" + varname + "_" + model_name + "_ws_" + str(ws_use) + "_test.csv")
...
if test_a_model:
    for filename in os.listdir("actual_train"):
        for ws_use in ws_range:
            ...
            model.seq2seq.load_state_dict(torch.load("train_attention" + str(ws_use - min(ws_range) + 1 + len(ws_range) * 3) + "/" + varname + "/models/" + model_name + "/" + varname + "_" + model_name + "_ws_" + str(ws_use) + ".pth"))
