...
for varname in os.listdir("train_pytorch"):
    ...
    for model_name in os.listdir("train_pytorch/" + varname + "/predictions/val/"):
        ...
        if is_a_nan:
            final_val_RMSE.append(1000000)
        else: 
            final_val_RMSE.append(math.sqrt(mean_squared_error(final_val_data["actual"], final_val_data["predicted"])) / (max(all_mine_flat) - min(all_mine_flat)))
