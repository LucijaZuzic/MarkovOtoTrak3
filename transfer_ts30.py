...
for ws_use in ws_range:
    ...
    file_yml_pre_write_all = open("csv30data/data_provider/" + str(ws_use) + "/30multi_task_pretrain_all.yaml", "w")
    file_yml_pre_write_all.write(yml_part.replace("TRAIN", "ALL"))
    file_yml_pre_write_all.close()

    file_yml_pre_write = open("csv30data/data_provider/" + str(ws_use) + "/30multi_task_pretrain.yaml", "w")
    file_yml_pre_write.write(yml_part)
    file_yml_pre_write.close()
    
    file_yml_pre_write_val = open("csv30data/data_provider/" + str(ws_use) + "/30multi_task_pretrain_val.yaml", "w")
    file_yml_pre_write_val.write(yml_part.replace("TRAIN", "TRAIN_VAL"))
    file_yml_pre_write_val.close()
    
    file_yml_write_all = open("csv30data/data_provider/" + str(ws_use) + "/30zeroshot_task_all.yaml", "w")
    file_yml_write_all.write(yml_part.replace("pretrain_", "").replace("TRAIN", "ALL"))
    file_yml_write_all.close()

    file_yml_write_val = open("csv30data/data_provider/" + str(ws_use) + "/30zeroshot_task_val.yaml", "w")
    file_yml_write_val.write(yml_part.replace("pretrain_", "").replace("TRAIN", "VAL"))
    file_yml_write_val.close()

    file_yml_write = open("csv30data/data_provider/" + str(ws_use) + "/30zeroshot_task.yaml", "w")
    file_yml_write.write(yml_part.replace("pretrain_", "").replace("TRAIN", "TEST"))
    file_yml_write.close()
    
    file_yml_write_train = open("csv30data/data_provider/" + str(ws_use) + "/30zeroshot_task_train.yaml", "w")
    file_yml_write_train.write(yml_part.replace("pretrain_", ""))
    file_yml_write_train.close()

    file_yml_S_pre_write_all = open("csv30data/data_provider/" + str(ws_use) + "/30multi_task_pretrain_all_S.yaml", "w")
    file_yml_S_pre_write_all.write(yml_part.replace("features: M", "features: S").replace("TRAIN", "ALL"))
    file_yml_S_pre_write_all.close()

    file_yml_S_pre_write = open("csv30data/data_provider/" + str(ws_use) + "/30multi_task_pretrain_S.yaml", "w")
    file_yml_S_pre_write.write(yml_part.replace("features: M", "features: S"))
    file_yml_S_pre_write.close()
    
    file_yml_S_pre_write_val = open("csv30data/data_provider/" + str(ws_use) + "/30multi_task_pretrain_val_S.yaml", "w")
    ...
    file_yml_S_write_all = open("csv30data/data_provider/" + str(ws_use) + "/30zeroshot_task_all_S.yaml", "w")
    ...
    file_yml_S_write_val = open("csv30data/data_provider/" + str(ws_use) + "/30zeroshot_task_val_S.yaml", "w")
    ...
    file_yml_S_write = open("csv30data/data_provider/" + str(ws_use) + "/30zeroshot_task_S.yaml", "w")
    file_yml_S_write.write(yml_part.replace("features: M", "features: S").replace("pretrain_", "").replace("TRAIN", "TEST"))
    file_yml_S_write.close()
    
    file_yml_S_write_train = open("csv30data/data_provider/" + str(ws_use) + "/30zeroshot_task_train_S.yaml", "w")
    file_yml_S_write_train.write(yml_part.replace("features: M", "features: S").replace("pretrain_", ""))
    file_yml_S_write_train.close()

    file_yml_MS_pre_write_all = open("csv30data/data_provider/" + str(ws_use) + "/30multi_task_pretrain_all_MS.yaml", "w")
    file_yml_MS_pre_write_all.write(yml_part.replace("features: M", "features: MS").replace("TRAIN", "ALL"))
    file_yml_MS_pre_write_all.close()

    file_yml_MS_pre_write = open("csv30data/data_provider/" + str(ws_use) + "/30multi_task_pretrain_MS.yaml", "w")
    file_yml_MS_pre_write.write(yml_part.replace("features: M", "features: MS"))
    file_yml_MS_pre_write.close()
    
    file_yml_MS_pre_write_val = open("csv30data/data_provider/" + str(ws_use) + "/30multi_task_pretrain_val_MS.yaml", "w")
    ...
    file_yml_MS_write_all = open("csv30data/data_provider/" + str(ws_use) + "/30zeroshot_task_all_MS.yaml", "w")
    ...
    file_yml_MS_write_val = open("csv30data/data_provider/" + str(ws_use) + "/30zeroshot_task_val_MS.yaml", "w")
    ...
    file_yml_MS_write = open("csv30data/data_provider/" + str(ws_use) + "/30zeroshot_task_MS.yaml", "w")
    ...
    file_yml_MS_write_train = open("csv30data/data_provider/" + str(ws_use) + "/30zeroshot_task_train_MS.yaml", "w")
    ...
    for filename in os.listdir("actual_train"):
        ...
        file_yml_part_var_pre_write_all = open("csv30data/data_provider/" + str(ws_use) + "/30multi_task_pretrain_all_" + varname + ".yaml", "w")
        file_yml_part_var_pre_write_all.write(yml_part_var[varname].replace("TRAIN", "ALL"))
        file_yml_part_var_pre_write_all.close()
 
        file_yml_part_var_pre_write = open("csv30data/data_provider/" + str(ws_use) + "/30multi_task_pretrain_" + varname + ".yaml", "w")
        file_yml_part_var_pre_write.write(yml_part_var[varname])
        file_yml_part_var_pre_write.close()
        
        file_yml_part_var_pre_write_val = open("csv30data/data_provider/" + str(ws_use) + "/30multi_task_pretrain_val_" + varname + ".yaml", "w")
        file_yml_part_var_pre_write_val.write(yml_part_var[varname].replace("TRAIN", "TRAIN_VAL"))
        file_yml_part_var_pre_write_val.close()
        
        file_yml_part_var_write_all = open("csv30data/data_provider/" + str(ws_use) + "/30zeroshot_task_all_" + varname + ".yaml", "w")
        ...
        file_yml_part_var_write_val = open("csv30data/data_provider/" + str(ws_use) + "/30zeroshot_task_val_" + varname + ".yaml", "w")
        ...
        file_yml_part_var_write = open("csv30data/data_provider/" + str(ws_use) + "/30zeroshot_task_" + varname + ".yaml", "w")
        file_yml_part_var_write.write(yml_part_var[varname].replace("pretrain_", "").replace("TRAIN", "TEST"))
        file_yml_part_var_write.close()
        
        file_yml_part_var_write_train = open("csv30data/data_provider/" + str(ws_use) + "/30zeroshot_task_train_" + varname + ".yaml", "w")
        file_yml_part_var_write_train.write(yml_part_var[varname].replace("pretrain_", ""))
        file_yml_part_var_write_train.close()

        file_yml_part_var_S_pre_write_all = open("csv30data/data_provider/" + str(ws_use) + "/30multi_task_pretrain_all_S_" + varname + ".yaml", "w")
        ...
        file_yml_part_var_S_pre_write = open("csv30data/data_provider/" + str(ws_use) + "/30multi_task_pretrain_S_" + varname + ".yaml", "w")
        ...
        file_yml_part_var_S_pre_write_val = open("csv30data/data_provider/" + str(ws_use) + "/30multi_task_pretrain_val_S_" + varname + ".yaml", "w")
        ...
        file_yml_part_var_S_write_all = open("csv30data/data_provider/" + str(ws_use) + "/30zeroshot_task_all_S_" + varname + ".yaml", "w")
        ...
        file_yml_part_var_S_write_val = open("csv30data/data_provider/" + str(ws_use) + "/30zeroshot_task_val_S_" + varname + ".yaml", "w")
        ...
        file_yml_part_var_S_write = open("csv30data/data_provider/" + str(ws_use) + "/30zeroshot_task_S_" + varname + ".yaml", "w")
        ...
        file_yml_part_var_S_write_train = open("csv30data/data_provider/" + str(ws_use) + "/30zeroshot_task_train_S_" + varname + ".yaml", "w")
        ...
        file_yml_part_var_MS_pre_write_all = open("csv30data/data_provider/" + str(ws_use) + "/30multi_task_pretrain_all_MS_" + varname + ".yaml", "w")
        ...
        file_yml_part_var_MS_pre_write = open("csv30data/data_provider/" + str(ws_use) + "/30multi_task_pretrain_MS_" + varname + ".yaml", "w")
        ...
        file_yml_part_var_MS_pre_write_val = open("csv30data/data_provider/" + str(ws_use) + "/30multi_task_pretrain_val_MS_" + varname + ".yaml", "w")
        ...
        file_yml_part_var_MS_write_all = open("csv30data/data_provider/" + str(ws_use) + "/30zeroshot_task_all_MS_" + varname + ".yaml", "w")
        ...
        file_yml_part_var_MS_write_val = open("csv30data/data_provider/" + str(ws_use) + "/30zeroshot_task_val_MS_" + varname + ".yaml", "w")
        ...
        file_yml_part_var_MS_write = open("csv30data/data_provider/" + str(ws_use) + "/30zeroshot_task_MS_" + varname + ".yaml", "w")
        ...
        file_yml_part_var_MS_write_train = open("csv30data/data_provider/" + str(ws_use) + "/30zeroshot_task_train_MS_" + varname + ".yaml", "w")
