...
model_name = "UniTS_varname"

if os.path.isfile("UniTS_final_result_varname/predicted_all"):
    predicted_all = load_object("UniTS_final_result_varname/predicted_all")
    
if os.path.isfile("UniTS_final_result_varname/y_test_all"):
    y_test_all = load_object("UniTS_final_result_varname/y_test_all")

if os.path.isfile("UniTS_final_result_varname/ws_all"):
    ws_all = load_object("UniTS_final_result_varname/ws_all")
...
for varname in os.listdir("final_train_pytorch"):
    ...
    for ws_use in ws_range:
        ...
        final_test_data = pd.read_csv("UniTS_final_res_varname/" + str(ws_use) + "/" + varname + ".csv", index_col = False)
        ...
        if not os.path.isdir("UniTS_final_result_varname"):
            os.makedirs("UniTS_final_result_varname")

        save_object("UniTS_final_result_varname/predicted_all", predicted_all)
        save_object("UniTS_final_result_varname/y_test_all", y_test_all)
        save_object("UniTS_final_result_varname/ws_all", ws_all)
...
if os.path.isfile("UniTS_final_result_varname/predicted_long"):
    predicted_long = load_object("UniTS_final_result_varname/predicted_long")

if os.path.isfile("UniTS_final_result_varname/predicted_lat"):
    predicted_lat = load_object("UniTS_final_result_varname/predicted_lat")

if os.path.isfile("UniTS_final_result_varname/actual_long"):
    actual_long = load_object("UniTS_final_result_varname/actual_long")

if os.path.isfile("UniTS_final_result_varname/actual_lat"):
    actual_lat = load_object("UniTS_final_result_varname/actual_lat")
...
for ws_use in ws_range:
    ...
    save_object("UniTS_final_result_varname/actual_long", actual_long)
    save_object("UniTS_final_result_varname/actual_lat", actual_lat)
    save_object("UniTS_final_result_varname/predicted_long", predicted_long)
    save_object("UniTS_final_result_varname/predicted_lat", predicted_lat)