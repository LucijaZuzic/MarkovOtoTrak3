...
predicted_all = load_object("UniTS_final_result_no_time/predicted_all")
y_test_all = load_object("UniTS_final_result_no_time/y_test_all")
ws_all = load_object("UniTS_final_result_no_time/ws_all")

actual_long = load_object("UniTS_final_result_no_time/actual_long")
actual_lat = load_object("UniTS_final_result_no_time/actual_lat")
predicted_long = load_object("UniTS_final_result_no_time/predicted_long")
predicted_lat = load_object("UniTS_final_result_no_time/predicted_lat")

distance_predicted_new = dict()

if os.path.isfile("UniTS_final_result_no_time/distance_predicted_new"):
    distance_predicted_new = load_object("UniTS_final_result_no_time/distance_predicted_new")
    ...
    for model_name in predicted_long:
        ...
        for ws_use in predicted_long[model_name]:
            ...
            for dist_name in predicted_long[model_name][ws_use]:
                ...
                if "UniTS_no_time" not in dicti_to_print[dist_name]:
                    dicti_to_print[dist_name]["UniTS_no_time"] = dict()
                    
                if str(ws_use) not in dicti_to_print[dist_name]["UniTS_no_time"]:
                    dicti_to_print[dist_name]["UniTS_no_time"][str(ws_use)] = dict()

                dicti_to_print[dist_name]["UniTS_no_time"][str(ws_use)]["R2_wt"] = r2_pred_wt
                dicti_to_print[dist_name]["UniTS_no_time"][str(ws_use)]["MAE_wt"] = mae_pred_wt
                dicti_to_print[dist_name]["UniTS_no_time"][str(ws_use)]["RMSE_wt"] = rmse_pred_wt
                dicti_to_print[dist_name]["UniTS_no_time"][str(ws_use)]["Euclid"] = np.average(vals_avg)
                dicti_to_print[dist_name]["UniTS_no_time"][str(ws_use)]["R2"] = r2_pred
                dicti_to_print[dist_name]["UniTS_no_time"][str(ws_use)]["MAE"] = mae_pred
                dicti_to_print[dist_name]["UniTS_no_time"][str(ws_use)]["RMSE"] = rmse_pred

save_object("UniTS_final_result_no_time/distance_predicted_new", distance_predicted_new)
...
list_ws = sorted([int(x) for x in dicti_to_print["long no abs"]["UniTS_no_time"]])
