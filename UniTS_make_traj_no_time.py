...
if os.path.isfile("UniTS_final_result_no_time/predicted_all"):
    predicted_all = load_object("UniTS_final_result_no_time/predicted_all")
    
if os.path.isfile("UniTS_final_result_no_time/y_test_all"):
    y_test_all = load_object("UniTS_final_result_no_time/y_test_all")

if os.path.isfile("UniTS_final_result_no_time/ws_all"):
...
for varname in os.listdir("final_train_pytorch"):
    ...
    for ws_use in ws_range:
        ...
        if not os.path.isdir("UniTS_final_result_no_time"):
            os.makedirs("UniTS_final_result_no_time")

        save_object("UniTS_final_result_no_time/predicted_all", predicted_all)
        save_object("UniTS_final_result_no_time/y_test_all", y_test_all)
        save_object("UniTS_final_result_no_time/ws_all", ws_all)
...
if os.path.isfile("UniTS_final_result_no_time/predicted_long"):
    predicted_long = load_object("UniTS_final_result_no_time/predicted_long")

if os.path.isfile("UniTS_final_result_no_time/predicted_lat"):
    predicted_lat = load_object("UniTS_final_result_no_time/predicted_lat")

if os.path.isfile("UniTS_final_result_no_time/actual_long"):
    actual_long = load_object("UniTS_final_result_no_time/actual_long")

if os.path.isfile("UniTS_final_result_no_time/actual_lat"):
...
for ws_use in ws_range:
    ...
    save_object("UniTS_final_result_no_time/actual_long", actual_long)
    save_object("UniTS_final_result_no_time/actual_lat", actual_lat)
    save_object("UniTS_final_result_no_time/predicted_long", predicted_long)
    save_object("UniTS_final_result_no_time/predicted_lat", predicted_lat)